            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nis" class="col-md-4 col-form-label text-md-end">{{ __('NIS Sekolah') }}</label>
                        ...
                        {{-- <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="" name="kelas" class="form-control @error('kelas') is-invalid @enderror" value="{{ old('kelas') }}" required autocomplete="kelas">
