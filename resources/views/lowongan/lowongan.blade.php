    ...
    <div class="heading">
      <div class="container">
        <div class="row d-flex justify-content-center text-center">
          <div class="col-lg-8">
            <h1>Lowongan Tersedia</h1>
            <p class="mb-0">Disini anda bisa melihat seluruh Lowongan Kerja yang sudah kami publikasikan, pastikan Lowongan Kerja yang anda cari masih dibuka/ aktif.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-6">
          ...
          <article>
            ...
            <div class="d-flex align-items-center">
              <img src="{{ asset('storage/'.$lowongan->user->foto_profil) }}" alt="" class="img-fluid post-author-img flex-shrink-0">
              <div class="post-meta">
